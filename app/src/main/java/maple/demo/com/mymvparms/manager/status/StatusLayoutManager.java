package maple.demo.com.mymvparms.manager.status;
...
/**
 * <p>该类基于UI封装
 * 主要功能是显示网络错误页、加载页和空页面等
 * {@link BaseViewActivity#initStatusLayout 参考的使用方式}
 * </p>
 *
 * @author Yang
 * @date 2017/1/8
...
public class StatusLayoutManager {
    ...
    public StatusLayoutManager(Builder builder) {
        ...
        this.contentInflateView = builder.contentInflateView;
    ...
    public static final class Builder {
        ...
        private View contentInflateView;
        ...
        public Builder contentInflateView(View view) {
            this.contentInflateView = view;
            return this;
        }
