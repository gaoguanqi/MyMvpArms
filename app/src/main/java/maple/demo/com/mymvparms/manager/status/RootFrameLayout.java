...
public class RootFrameLayout extends FrameLayout {
    ...
    private void addAllLayoutToRootLayout() {
        ...
        if (mStatusLayoutManager.contentInflateView != null) addLayoutResId(mStatusLayoutManager.contentInflateView, RootFrameLayout.LAYOUT_CONTENT_ID);
    ...
    private void addLayoutResId(View view, int id) {
